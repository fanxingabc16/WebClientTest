...
@XmlType(name = "DiscoverPrinterOutput", propOrder = {
    "action",
    "option",
    "serialization",
    "version",
...
public class DiscoverPrinterOutput {
