 ...
 *         &lt;element name="state" type="{urn:dpcl:wsdl:2010-01-19}DataState"/&gt;
...
@XmlType(name = "DataStatus", namespace = "urn:dpcl:wsdl:2010-01-19", propOrder = {
    "parameter",
    "id",
    "state",
    "queuePosition",
