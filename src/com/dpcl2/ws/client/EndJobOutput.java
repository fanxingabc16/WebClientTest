...
@XmlType(name = "EndJobOutput", namespace = "urn:dpcl:wsdl:2010-01-19", propOrder = {
    "success",
    "checkStatus"
})
public class EndJobOutput {
